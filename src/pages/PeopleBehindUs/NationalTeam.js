...
import RakeshSenger from "../../assets/images/people/RakeshSenger.jpeg";
...
export default function NationalTeam() {
  return (
   ...
   <Col sm={6} md={3} className="pt-4">
      ...
      <Col sm={6} md={3} className="pt-4">
        <Card className="box-sdow">
          <Card.Img variant="top" src={RakeshSenger} />
          <Card.Body className="pb-0">
      ...
      <Col sm={6} md={3} className="pt-4">
        <Card className="box-sdow">
          ...
          <Card.Body className="pb-0">
            ...
            <Card.Text className="m-0">(Journalist)</Card.Text>
          </Card.Body>
        </Card>
      </Col>
      ...
      <Col sm={6} md={3} className="pt-4">
        <Card className="box-sdow">
          ...
          <Card.Body className="pb-0">
            ...
            <Card.Text className="m-0"> (Industrialist & Philanthropist)  </Card.Text>
          </Card.Body>
        </Card>
      </Col>
